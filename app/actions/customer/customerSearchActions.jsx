...
const searchCustomers = searchConditions => {
  return new Promise((resolve, reject) => {
    commonAjax
      .get(`${DEV_SERVER_ADDRESS}getCustomers`, searchConditions)
      .then(customersData => {
        resolve({
...
const addNewCustomer = customerInfo => {
  return new Promise((resolve, reject) => {
    commonAjax
      .post(`${DEV_SERVER_ADDRESS}addCustomer`, customerInfo)
      .then(returnData => {
        resolve(returnData);
      });
  });
...
const deleteCustomers = customerInfo => {
  return new Promise((resolve, reject) => {
    commonAjax
      .delete(`${DEV_SERVER_ADDRESS}deleteCustomers`, customerInfo)
      .then(returnData => {
        resolve(returnData);
      });
  });
...
const update = customerInfo => {
  return new Promise((resolve, reject) => {
    commonAjax
      .update(`${DEV_SERVER_ADDRESS}updateCustomer`, customerInfo)
      .then(returnData => {
        resolve(returnData);
      });
  });
...
export { searchCustomers, addNewCustomer, deleteCustomers, update };
